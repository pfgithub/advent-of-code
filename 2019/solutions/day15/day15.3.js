...
(async () => {
	...
	// 	await testdir(west);
	// };
	// let dirs = "ddddssdddssddssddssddwwddddwwddwwwwwwwwwwwddwwaaaaaassssssssaass".split(
	// 	"",
	// );
	// while (true) {
	// 	await testAll();
	...
	// 	drawGame();
	// 	let dirml = await getLine();
	// 	console.log(dirml);
	// 	await go({ w: north, a: west, s: south, d: east }[dirml]);
	// 	console.log(dirml);
	// }
	// drawGame();
	// console.log("done");
